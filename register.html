...
<body>
	...
	<div class="login-block" >
		...
		<?php include('errors.php'); ?>	
			<h1>Register</h1>
			<h2>Enter your details below to register and start using Lucid Planner</h2>
			...
			<h2><span>Already a member? </span> <span class="underline"><a href="login.php"> Sign in here</a></span></h2>
		</form>		
	</div>
